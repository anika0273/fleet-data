...
def create_table_if_not_exists():
    ...
    CREATE TABLE IF NOT EXISTS fleet_stream_processed (
        ...
        warehouse_destination VARCHAR,
        supplier_id VARCHAR,
        supplier_region VARCHAR,
        carrier_service_level VARCHAR,
        ...
        customs_hold_duration_min DOUBLE PRECISION,
        ...
        loading_delay_minutes DOUBLE PRECISION,
        shipment_status VARCHAR,
        late_shipment_cost_usd DOUBLE PRECISION,
...
def define_schema():
    return StructType([
        ...
        StructField("warehouse_origin", StringType()),
        StructField("warehouse_destination", StringType()),
        StructField("supplier_id", StringType()),
        StructField("supplier_region", StringType()),
        StructField("carrier_service_level", StringType()),
        StructField("planned_departure_time", TimestampType()),
        StructField("actual_departure_time", TimestampType()),
        StructField("planned_arrival_time", TimestampType()),
        StructField("actual_arrival_time", TimestampType()),
        StructField("eta_minutes", DoubleType()),
        StructField("delay_minutes", DoubleType()),
        StructField("customs_hold_flag", BooleanType()),
        StructField("customs_hold_duration_min", DoubleType()),
        StructField("weather_delay_flag", BooleanType()),
        StructField("weather_delay_minutes", DoubleType()),
        StructField("traffic_delay_flag", BooleanType()),
        StructField("traffic_delay_minutes", DoubleType()),
        StructField("loading_delay_flag", BooleanType()),
        StructField("loading_delay_minutes", DoubleType()),
        StructField("shipment_status", StringType()),
        StructField("late_shipment_cost_usd", DoubleType()),
